            ...
            <section class="section">
                <div class="container mt-4 mb-4">
                    <div class="columns is-vcentered">
                        ...
                        <div class="column is-6">
                            <img src="/images/audiMember.avif" alt="Audi-member" />
                        </div>
                    </div>
                </div>
            </section>
            ...
            <div className="landing-page">
                <section class="section has-background-black">
                    <div class="container mt-4 mb-4">
                        <div class="columns is-vcentered">
                            <div class="column is-6">
                                <img src="/images/audi-eolienne.avif" alt="Your image" />
                            </div>
                            <div class="column is-6">
                                <h2 class="title is-2 has-text-left has-text-white">Engagements sociaux et environnementaux</h2>
                                <p className="has-text-white">Audi considère que la durabilité consiste à avoir une responsabilité envers l'avenir en équilibrant les aspects économiques, écologiques et sociaux. La transparence, l'intégrité et une vision à long terme sont également des éléments importants pour Audi. En adoptant une attitude responsable, Audi aspire à être un leader en matière de durabilité.</p>
                            </div>
                        </div>
                    </div>
                </section>
                    ...
                    <div class="container mt-4 mb-4">
                        <div class="columns is-vcentered">
                            <div class="column is-6 ">
                                ...
                                <p>Peu importe où vous êtes dans le monde, notre service clientèle vous aidera pour toute question ou demande concernant Audi. Il suffit de sélectionner le pays ou la région de vente correspondante dans le menu ci-dessous. Nos employés seront heureux de vous aider.</p>
                            </div>
                            <div class="column is-6">
                                <img src="/images/audi-contact.avif" alt="Audi-contact" />
                            </div>
                        </div>
                    </div>
                </section>
